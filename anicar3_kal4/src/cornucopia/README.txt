This is a partial clone and port to MRT tools of github.com/baran37/cornucopia-lib (lib only, you can find the demo_ui [here](https://gitlab.mrt.uni-karlsruhe.de/MRT/cornucopia_tool).

Originally intended to smooth handdrawn paths, this library can easily be used to smooth and interpolate other types of paths using line, circle and clothoid segments.
Use the demo_ui in `cornucopia_tool` to find good parameters.
