...
static const std::map<std::string, level> level_string{{spdlog::level::level_names[level::trace], level::trace},
                                                       {spdlog::level::level_names[level::debug], level::debug},
                                                       ...
                                                       {spdlog::level::level_names[level::critical], level::critical},
                                                       {spdlog::level::level_names[level::off], level::off}};
